...
<body>
  ...
  <div class="hero-unit">
  <div>
  <h2><em>Contact Us</em></h2> </div>
  <br/>
  
		<p align="center"><img src="static/images/contatti_basso.jpg" class="sale-photo"></p>
	
		<h3>
				Contact us by filling the form below
		</h3>
	
		<form method="post" action="/PoliMed">
		  ...
		  <option value="E">Rest of the World</option>
		  </select><br>
